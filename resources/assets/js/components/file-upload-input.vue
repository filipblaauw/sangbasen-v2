<template>
  <div>
    ...
    <button class="btn btn-danger btn-sm m-t-10" @click="cancelUpload" v-if="progress"><i class="fas fa-trash"></i></button>

    <ul class="upload-file-list m-t-20" v-if="uploaded_files && !clearFile">
