    ...
    <div>
        <div class="row page-titles">
            <div class="col-md-6 col-8 align-self-center">
                <h3 class="m-b-0 m-t-0">{{trans('user.user_detail')}}</h3>
                <ol class="breadcrumb">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12 col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <datepicker language="nb-no" :monday-first="true" v-model="userForm.date_of_anniversary" :bootstrapStyling="true" name="date_of_anniversary" @selected="userForm.errors.clear('date_of_anniversary')"></datepicker>
